...
class ConvertGroupuser extends AbstractCommand
{  
...
//    exit;
    ...
    $sqlSelect = 'SELECT `group_id`, `user_id`, `role_id`
      FROM group_user ORDER BY group_id ASC LIMIT ';
      
    $sqlInsert = 'INSERT INTO Mod_GroupUser (`GroupId`, `UserId`, `RoleId`) 
      VALUES ';
