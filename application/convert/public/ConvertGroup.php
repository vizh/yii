...
class ConvertGroup extends AbstractCommand
{  
...
//    exit;
    ...
    $sqlSelect = 'SELECT `group_id`, `name`, `info`, `private`
      FROM group_name ORDER BY group_id ASC LIMIT ';
      
    $sqlInsert = 'INSERT INTO Mod_Group (`GroupId`, `Name`, `Info`, `Private`) 
      VALUES ';
