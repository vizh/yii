...
class ConvertEventroles extends AbstractCommand
{
...
//    exit;
    ...
    $sqlSelect = 'SELECT `role_id`, `type`, `name`
      FROM proj_user_roles ORDER BY role_id ASC LIMIT ';
      
    $sqlInsert = 'INSERT INTO EventRoles (`RoleId`, `Type`, `Name`) 
      VALUES ';            
