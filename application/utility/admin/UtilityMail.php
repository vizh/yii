...
class UtilityMail extends AdminCommand
{
  ...
  public static $MailName = 'i-research-3';
...
//    $criteria->addInCondition('EventUsers.EventId', array(95,43,9,171,107,200,248,196));
    ...
    //$criteria->addInCondition('EventUsers.EventId', array(258, 245, 176, 153, 200));
...
//    $this->mail->RoleName = $user->EventUsers[0]->EventRole->Name;
    ...
    $mail->CharSet = 'utf-8';
    $mail->Subject = '=?UTF-8?B?'. base64_encode('«ЭКОНОМИКА РУНЕТА-2012». ЭЛЕКТРОННАЯ АНКЕТА') .'?=';
    $mail->Body = $this->mail;
