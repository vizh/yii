...
return [
    ...
    'runetid.jquery.ui' => [
        'baseUrl' => '/javascripts/',
        'js' => ['jquery-ui-1.9.0.custom.min.js', 'jquery.ui.autocomplete.html.js',
            '/jquery.ui/jquery-ui-autocomplete-bootstrap-style.js'],
    ...
    'runetid.application' => [
        ...
        'depends' => ['runetid.jquery', 'runetid.jquery.ui', 'runetid.backbone', 'runetid.bootstrap',
            'runetid.jquery.ioslider', 'runetid.auth'],
    ],
