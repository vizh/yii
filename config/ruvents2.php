    ...
    'components' => [
        ...
        'urlManager' => [
            'rules' => [
                ...
                ['ruvents2/products/checks', 'pattern' => RUVENTS_API_HOST.'/products/<id:\d+>/checks', 'verb' => 'GET'],
                ['ruvents2/products/check', 'pattern' => RUVENTS_API_HOST.'/products/<id:\d+>/checks', 'verb' => 'POST'],
