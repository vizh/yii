  ...
  <TABLE cellSpacing="0" cellPadding="5" width="720" border="0">
	...
	<TR>
		<TD colspan="2" style="font-size: 11px;">
			...
			Денежные средства в оплату счета должны поступить на расчетный счет ЗАО «Ашманов и партнеры» <strong>не позднее 3 (трех) банковских дней</strong> с даты выставления счета.<BR/>
