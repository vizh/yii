...
<DIV id=content>
  <TABLE cellSpacing="0" cellPadding="5" width="720" border="0">
    <TBODY>
    <TR>
      <TD><b>ООО «Эвотек»</b><BR>Адрес: 129090, г. Москва, Троицкая ул., д. 13<BR></TD>
    ...
    <TR>
      <TD colspan="2">
        ...
        <TABLE style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; WIDTH: 100%; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" cellSpacing="0" cellPadding="3">
          <TBODY>
          <TR>
            <TD style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid">ИНН 7702759151</TD>

            <TD style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid">КПП 770201001</TD>
            <TD style="BORDER-BOTTOM: 1px solid">&nbsp;</TD>
            <TD style="BORDER-BOTTOM: 1px solid">&nbsp;</TD>
          </TR>
          <TR>
            <TD style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid"	colSpan=2>Получатель<BR>ООО «Эвотек»</TD>
            <TD	style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid"><BR>Сч.	№</TD>

            <TD style="BORDER-BOTTOM: 1px solid"><BR>40702810038090007260</TD></TR>
          <TR>
            <TD style="BORDER-RIGHT: 1px solid" colSpan=2>Банк получателя<BR>СБЕРБАНК РОССИИ ОАО Г.МОСКВА</TD>
            <TD style="BORDER-RIGHT: 1px solid">БИК<BR>Сч. №</TD>
            <TD>044525225<BR>30101810400000000225</TD>
    ...
    <TR>
      <TD colspan="2">
        <IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none; width: 720px;"
              src="/images/bill/event363/bill_withsing.png"
            />
      </TD>
    </TR>
    <?else:?>
    <TR>
      <TD colspan="2">
        <IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none width: 720px;"
              src="/images/bill/event363/bill_nosing.png"
            />
      </TD>
    </TR>
    <?endif;?>
