          ...
          <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 50px; border-top: 0;">
            <tbody>
              ...
              <tr>
                <td></td>
                <td>
                  <p style="margin-bottom:  15px;">Рады сообщить Вам, что на конференции IBC Russia 2013 пройдут две бонус-секции.</p>
                  <p style="margin-bottom:  15px;">Мария Моева и Андрей Липатцев из отдела качества поиска Google проведут «<a href="http://ibcrussia.com/program/block/bonus-2.php?utm_source=bonusrass">Клинику сайтов</a>». Специалисты рассмотрят ваш интернет-проект и дадут практические советы, как сделать его более удобным для пользователей и поисковиков.</p>
