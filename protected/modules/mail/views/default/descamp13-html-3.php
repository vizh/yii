			...
			<td style="background: #ffffff;">
				<table width="600" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border: 5px solid #194291;">
                  ...
                  <td>
                    ...
                    <a href="http://events.techdays.ru/DesCamp/2013-12/" style="display: block; text-decoration: none; background: #333333; color: #FFFFFF; font-family: Arial,Verdana,sans-serif; font-size: 20px; margin: 0 auto; padding: 12px; text-align: center; width: 300px;">Смотреть онлайн</a>
