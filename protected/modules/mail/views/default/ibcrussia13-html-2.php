          ...
          <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 50px; border-top: 0;">
            <tbody>
              ...
              <tr>
                <td></td>
                <td>
                  <h3>Internet Business Conference Russia 2013 (Интернет для бизнеса) - крупнейшая отраслевая конференция для бизнеса, объединившая в себе опыт многолетних успешных проектов «Сайт» и Optimization.</h3>
                  ...
                  <ul style="margin-bottom:  10px;">
                    ...
                    <li>секреты управления репутацией в Интернете;</li>
                    <li>специальный интенсив-курс для начинающих специалистов - «Академия интернет-проектов»;</li>
                    <li>развернутые комментарии экспертов по волнующим вопросам в рамках дискуссионных панелей и круглых столов;</li>
                    <li>деловые встречи и новые контакты.</li>
                  </ul>

                  <h3 style="margin: 10px 0;">ВЫСТАВКА</h3>
                  <p style="margin-bottom:  5px;">Участники выставки — компании-лидеры Рунета: ведущие веб-разработчики, агентства интернет-маркетинга, создатели рекламных сетей и сервисов.</p>
                  <p style="margin-bottom:  5px;">На выставочных стендах вы сможете ознакомиться с актуальными предложениями для рекламодателей, новыми услугами, а также установить деловые контакты со специалистами крупнейших отраслевых компаний.</p>
