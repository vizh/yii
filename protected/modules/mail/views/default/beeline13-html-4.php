                  ...
                  <tr>
                    ...
                    <td valign="top" width="411" height="175" style="background: url('http://runet-id.com/img/event/beesuper13/str-3-2.png') no-repeat;">
                      <div style="padding: 0 10px;">
                        <h1 style="font-family: Verdana; font-size: 18px; margin: 0; padding: 0; font-weight: normal; line-height: 28px; color: #000000;">Дорогой коллега, приглашаем тебя на новогодний слет супергероев &laquo;Билайн&raquo;!</h1>
                        <div style="font-family: Verdana; font-size: 11px; line-height: 19px; margin-top: 12px;">На празднике мы, как всегда, сможем продемонстрировать свои неограниченные возможности. Вместе вспомним наши подвиги и достижения уходящего года и зарядимся суперсилой для исполнения своей миссии в 2014 году!</div>
                      </div>
                    </td>
                    <td valign="top" width="295" height="175"><img style="border: 0;" border="0" src="http://runet-id.com/img/event/beesuper13/str-3-3.png" width="295" height="175"></td>
                  </tr>
                </table>
              </td>
            </tr>
                ...
                <table width="750" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; margin: 0; padding: 0; border-spacing: 0;">
                  <tr>
                    ...
                    <td valign="top" style="background: #ffffff; font-family: Verdana; font-size: 16px; line-height: 23px; padding-left: 5px; padding-top: 15px; font-style: italic;">
                      Приходи с позитивным настроем в костюме супергероя:)
                    </td>
                    <td valign="top" width="505" height="101"><img style="border: 0;" border="0" src="http://runet-id.com/img/event/beesuper13/str-5-3.png" width="505" height="101"></td>
                  </tr>
                </table>
              </td>
            </tr>
                ...
                <table width="750" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; margin: 0; padding: 0; border-spacing: 0;">
                  <tr>
                    <td valign="top" bgcolor="#95969b" style="background: #95969b; font-family: Verdana; line-height: 15px; font-size: 11px; padding-left: 30px; padding-top: 25px;">
                      ...
                      <div style="color: #ffffff; margin-top: 10px;">Просьба при себе иметь<br/>распечатанное или электронное<br/>приглашение и служебный<br/>пропуск. Все QR-коды<br/>персонифицированы, передача<br/>другим сотрудникам невозможна.</div>
                    </td>
                    <td valign="top" width="514" height="198"><img style="border: 0;" border="0" src="http://runet-id.com/img/event/beesuper13/str-8-2.png" width="514" height="198"></td>
                  </tr>
                </table>
              </td>
            </tr>
