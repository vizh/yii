          ...
          <tr>
            <td style="padding-top: 20px; padding-left: 30px; padding-right: 30px; background-color: #ffffff">
              <table style="width: 100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <span style="color: #89CCC7; font-size: 35px; font-weight: bold;">Путевой лист &mdash;<br/>Право на Download</span>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="text-align: center; padding-top: 20px;">
                    <img src="http://runet-id.com/images/mail/download13/warning.png">
                  </td>
                </tr>
                <tr>
                  <td style="padding-top: 10px;">
                ...
                <tr>
                  <td style="padding-top: 10px;"><img src="http://runet-id.com/images/mail/download13/map.jpg" border="0"/></td>
                </tr>
                <tr>
