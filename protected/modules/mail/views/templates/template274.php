<?
$event  = \event\models\Event::model()->findByPk(1519);
$invite = \event\models\Invite::create($event, \event\models\Role::model()->findByPk(1));
?>
                  ...
                  <tr style="padding: 0;vertical-align: top;text-align: left;">
                    ...
                    <table class="twelve columns" style="border-spacing: 0;border-collapse: collapse;padding: 0;vertical-align: top;text-align: left;margin: 0 auto;width: 580px;">
                        <tr style="padding: 0;vertical-align: top;text-align: left;">
                          ...
                          <p style="margin: 0;margin-bottom: 10px;color: #222222;font-family: &quot;Helvetica&quot;, &quot;Arial&quot;, sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 19px;font-size: 14px;"><strong><span style="color:#2E8437">Пожалуйста, примите решение об участии до 1 декабря.</span></strong><br/>
  <img src="http://runet-id.com/img/mail/2014/lrm_invitation.jpg" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;width: auto;max-width: 100%;float: left;clear: both;display: block;">
</p>
                          </tr>
                          </table>
...
Леруа Мерлен в России продолжает расти и развиваться во всех направлениях ещё более уверенными шагами. И сегодня мы хотим поделиться с вами своей стратегией для того, чтобы в будущем достигать наилучших результатов.
</p>

<p style="margin: 0;margin-bottom: 10px;color: #222222;font-family: &quot;Helvetica&quot;, &quot;Arial&quot;, sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 19px;font-size: 14px;">
<b>8 декабря 2014 года</b> состоится крупнейшая в российской истории Леруа Мерлен конференция поставщиков &laquo;СТРАТЕГИЯ РАЗВИТИЯ ЛЕРУА МЕРЛЕН: ИНТЕРНЕТ, ЦЕПЬ ПОСТАВОК, ЗАКУПКИ&raquo;.
</p>

<p style="margin: 0;margin-bottom: 10px;color: #222222;font-family: &quot;Helvetica&quot;, &quot;Arial&quot;, sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 19px;font-size: 14px;">
Компания &quot;Леруа Мерлен Восток&quot; приглашает всех своих партнеров принять участие в этой конференции и очень надеется увидеть Вас среди участников.
</p>
...
С уважением, <br> Генеральный директор Леруа Мерлен Россия, Венсан Жанти
</p>

<hr style="height: 1px;border: none;border-top: 1px solid #eaeaea;margin: 25px 0;color: #d9d9d9;background-color: #d9d9d9;">

<p style="margin: 0;margin-bottom: 10px;color: #222222;font-family: &quot;Helvetica&quot;, &quot;Arial&quot;, sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 19px;font-size: 14px;">
<b>
ВНИМАНИЕ! Мы приглашаем ГЕНЕРАЛЬНЫХ ДИРЕКТОРОВ ИЛИ ИХ ПРЕДСТАВИТЕЛЕЙ. От одной компании может присутствовать только один человек!
</b>
</p>
...
<p style="margin-bottom: 5px;text-align: center;margin: 0;color: #222222;font-family: &quot;Helvetica&quot;, &quot;Arial&quot;, sans-serif;font-weight: normal;padding: 0;line-height: 19px;font-size: 14px;">
Для регистрации на мероприятие, пожалуйста, заполните форму. Необходимо указать данные человека, который будет присутствовать.
</p>
