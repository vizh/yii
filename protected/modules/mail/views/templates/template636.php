...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
  <head>
    ...
    <title>Напоминаем, что уже 20 сентября завершается приём работ на ключевой и старейший российский конкурс интернет-проектов России Золотой Сайт 2015</title>
  </head>
  <body bgcolor="#EBC50C" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; background: #EBC50C; margin: 0; padding: 0;"><style type="text/css">
...
<table class="body-wrap" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;"><tr style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"></td>
    <td class="container" bgcolor="#EBC50C" border="0" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 0; border: 0;">
      <!-- header -->
      <img src="https://showtime.s3.amazonaws.com/201509141403-gs15.jpg" style="height: auto; width: 100%; font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; max-width: 100%; margin: 0; padding: 0;" /></td>
    <td style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"></td>
		...
		<td class="container" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 20px;">
			...
			<table style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;"><tr style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
						...
						<p align="center"><img src="https://showtime.s3.amazonaws.com/201509141554-gs15.png" style="height: auto; width: 100%;"></p>
						<p style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 15px 0 20px; padding: 0;">В прошлом году конкурс и его Церемония Награждения вышли на новый уровень (обязательно посмотрите наш <a href="https://www.facebook.com/media/set/?set=a.856324437721163.1073741827.184554698231477" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; color: #348eda; margin: 0; padding: 0;">фотоотчет с прошлого года</a>), было весело, статусно и многолюдно. А вот этом году будет еще лучше!</p>
						<div class="center" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; text-align: center; margin: 0; padding: 0;" align="center">
							<a href="http://2015.goldensite.ru/personal/introduce/" class="btn-primary" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.2; color: #000; text-decoration: none; text-align: center; cursor: pointer; display: inline-block; text-transform: uppercase; background: #fff; margin: 0 auto; padding: 12px 65px; border: 2px solid #000;"><b style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">Подать заявку</b></a>
						</div>
						<p style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 15px 0 20px; padding: 0;">В 2015 году заявки на участие в конкурсе принимаются более чем в 50 номинациях конкурса. Кроме этого, будут вручены гран-при, приз зрительских симпатий, а также статуэтки лучшим региональным проектам по ключевым федеральным округам России.</p>
						<p style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 15px 0 20px; padding: 0;"><strong style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">Этапы прохождения конкурса «Золотого Сайта»:</strong></p>
						<ul style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;"><li style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 5px 0 5px 35px; padding: 0; list-style: outside;">Приём конкурсных работ — до 20 сентября.</li>
							<li style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 5px 0 5px 35px; padding: 0; list-style: outside;">Народное голосование и голосование жюри — до 8 октября.</li>
							<li style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 5px 0 5px 35px; padding: 0; list-style: outside;">Церемония Награждения — пройдет 22 октября 2015 в Москве в клубе «СНОБ» (вечером после второго дня конференции <a href="http://riw.moscow" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; color: #348eda; margin: 0; padding: 0;">RIW-15</a>).</li>
						</ul><p style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 15px 0 20px; padding: 0;"><strong style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">Прочитать подробнее о Золотом Сайте и подать ваши проекты можно <a href="http://2015.goldensite.ru/" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; color: #348eda; margin: 0; padding: 0;">на официальном сайте Конкурса</a>. Участвуйте и побеждайте!</strong></p>
					</td>
				</tr></table></div>
			<!-- /content -->
		...
		<td class="container" bgcolor="#EBC50C" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 20px;">
			<!-- content -->
			<div class="content" style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; max-width: 600px; display: block; margin: 0 auto; padding: 0;">
			<table style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;"><tr style="font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="color: #ffffff; text-align: center; font-family: Verdana, Geneva, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;" align="center">
						<h2 style="color: #ffffff; font-size: 3em; font-weight: bold; font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; line-height: 1.2; margin: 40px 0 10px; padding: 0;">Проект «Голос Рунета»</h2>
						<p style="font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 15px 0 20px; padding: 0;">Приглашаем принять участие в голосовании</p>
					</td>
				</tr></table></div>
			<!-- /content -->
