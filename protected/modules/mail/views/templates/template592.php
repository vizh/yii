...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
  <head>
    ...
    <title>Приглашаем принять участие в работе над проектом долгосрочной программы развития Рунета</title>
  </head>
...
<table class="body-wrap" bgcolor="#f6f6f6" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 20px;"><tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"></td>
		<td class="container" bgcolor="#FFFFFF" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 20px; border: 1px solid #f0f0f0;">
			...
			<table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;"><tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
                        ...
                        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;"><b style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><a style="color:#9e1869" href="http://iri.center/pk/">Программный комитет ИРИ</a> приглашает Вас принять участие в работе над проектом долгосрочной программы развития Рунета.</b></p>

                        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">За прошедшие с момента образования Программного комитета ИРИ 1,5 месяца было проведено более 80 очных встреч рабочих групп ПК,  а также получено и рассмотрено несколько сотен предложений специалистов интернет-индустрии.</p>

                        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">Экспертный вклад в наполнение проекта программы внесли все организации-учредители ИРИ, предоставив свои наработки по направлениям “медиа-коммуникации” (МКС), “интернет-экономика” (РАЭК), “цифровая грамотность” (РОЦИТ), “интернет-предпринимательство и инвестиции” (ФРИИ). Эти предложения вошли в соответствующие разделы разрабатываемого документа.</p>




                        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
Мы начинаем этап публичного обсуждение проекта предложений с членами экспертного сообщества ИРИ. <b style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">Приглашаем Вас перейти по персональной ссылке в Ваш Личный кабинет эксперта, ознакомиться с ходом работ и ответить на 3 вопроса Программного комитета.</b></p>


	<p style="text-align:center;">
<a href="http://xn--h1aax.xn--p1ai/experts/cabinet/projects/dev-program-of-internet.php?runetid=<?=$user->RunetId?>&hash=<?=md5($user->RunetId . '71064386e1731ff1ceb2b4667ce67b8c' . 'expertcabinet')?>" style="text-decoration: none;	color: #FFF; background-color: #9e1869; border: solid #9e1869; border-width: 10px 20px; line-height: 2; font-weight: bold; margin-right: 10px; text-align: center; cursor: pointer; display: inline-block; border-radius: 25px;">

ЛИЧНЫЙ КАБИНЕТ</a></p>



                        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">Ваше мнение важно для нас! Благодарим за сотрудничество!</p>
