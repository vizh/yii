...
<p>Напоминаем вам, что продолжается регистрация на практический семинар «Visual Data», посвященный новейшим инструментам визуализации и анализа данных, а также современным технологиям разработки приложений. Мероприятие состоится 18 марта 2015, в Москве, <a href="http://www.katerinahotels.com/ru/moscow/city/map/">бизнес-отель "Катерина Сити", конференц-зал "Цельсиус"</a>, с 10:00 до 13:00. Начало регистрации – в 9:30.</p>
...
<p>На семинаре выступят эксперты компании Qlik, а также представители компаний-партнеров, имеющие успешный опыт интеграции продуктовQlik в свои приложения и сервисы.</p>
