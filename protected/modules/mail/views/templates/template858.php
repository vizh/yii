...
<p>Просьба пройти дополнительную регистрацию через Runet-ID, чтобы данные отобразились в вашем личном профиле&nbsp;</p>
<div style="text-align: center; border: 0px dashed #B6CB1B; margin-top: 20px;">
	<p style="margin-top: 10px 0; text-align: center;"><a href="<?=$user->getFastauthUrl('/event/iriio16/')?>" style="font-size: 100%; color: #fff; text-decoration: none; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: uppercase; background-color: #BE1462; margin: 0 10px 0 0; padding: 0; border-color: #BE1462; border-style: solid; border-width: 10px 40px;">РЕГИСТРАЦИЯ</a></p>
</div>


<p style="text-align: center;"><strong>Адрес:</strong> Дмитровское ш. 9, Центр разработки и обучения фирмы 1С</p>

<p style="text-align: center;"><a href="http://1c.ru/rus/firm1c/scheme_d9.htm"><strong>Карта проезда</strong></a></p>

<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0 0 0 60px;">
                            <span class="dark-pink" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 10px;
                            line-height: 1.6; color: #7d1b6f; margin: 0; padding: 0;">Вы получили данное письмо, т.к. при самоидентификации по направлениям указали Образование.</p>

<hr />
<p><a href="https://telegram.me/it_today">Ежедневный IT-мониторинг ИРИ</a><br /></p>
<p><a href="https://www.facebook.com/groups/iriexperts/">Закрытая группа экспертов ИРИ</a></p>

<p><strong>ИРИ в социальных сетях:</strong></p>

<p><a href="https://www.facebook.com/iri.center/">Facebook</a>, <a href="https://twitter.com/IRI_Russia/">Twitter</a>, <a href="https://vk.com/iri_russia">Вконтакте</a>, <a href="https://www.instagram.com/iri_russia/">Instagram</a>, <a href="https://ok.ru/group/57764811243577">Одноклассники</a></p>

<p>&nbsp;</p>

<p>С уважением,</p>

<p>Институт Развития Интернета</p>
