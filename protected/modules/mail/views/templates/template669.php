		...
		<td class="container" bgcolor="#FFFFFF" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto; padding: 20px; border: 1px solid #f0f0f0;">
			...
			<table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;"><tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;"><td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
                ...
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    По поручению Совета Института Развития Интернета (ИРИ) имею честь предложить

                    Вам выдвинуть кандидата (кандидатов) в члены Клуба директоров ИРИ, первое

                    заседание которого запланировано в рамках проведения Российского Интернет

                    Форума (РИФ 2015).
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Клуб директоров ИРИ - это неформальное объединение топ-менеджеров медиа-,

                    интернет- и телеком индустрии, неравнодушных к вопросам развития

                    национального сегмента сети Интернет, российской экономики и страны в целом.

                    Это стремление вовлечь в серьезный диалог по важнейшим для Рунета проблемам

                    политиков, деловых людей и представителей интернет-сообщества. Создание Клуба

                    директоров является реакцией на запросы как со стороны государства, так и

                    современного российского интернет- и бизнес сообществ.
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Членами клуба могут являться как собственники или руководители бизнесов, так и

                    ключевые персоны, оказывающие непосредственное влияние на деятельность

                    компании и отрасли.
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Условием вступления в Клуб директоров является наличие рекомендаций от членов

                    Наблюдательного совета ИРИ. Окончательное решение о приеме кандидатов в

                    члены Клуба директоров ИРИ принимает Совет ИРИ.
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Приглашаем Вас принять участие в процессе выдвижения кандидатов. Просим

                    прислать Ваши предложения с указанием ФИО и занимаемой должности

                    кандидата(ов) до 15 апреля 2015 года в ответ на это письмо.
                </p>
                ...
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    ...
                    Директор Института Развития Интернета<br/>
                </p>
