...
<head>
    ...
    <title>Вы зарегистрированы на установочное собрание экспертов ИРИ, которое состоится завтра, 3 марта, по адресу: г. Москва, ул. Льва Толстого, 16, штаб-квартира «Яндекс», зал «Экстрополис».</title>
    <style>.btn-primary {
