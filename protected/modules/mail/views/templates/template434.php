...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
  <head>
    ...
    <title>Приглашение на Первое заседание Клуба Директоров Института Развития Интернета</title>
  </head>
...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">Главные цели создания ИРИ:</p>
<ul style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;"><li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">построение активно действующей дискуссионной межотраслевой площадки;</li>
<li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">консолидация отраслевых исследований, их интерпретация и популяризация результатов;</li>
<li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">налаживание диалога с властью между всеми участниками экосистемы Интернета.</li>
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;"><b style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">Основные направления деятельности ИРИ:</b></p>
<ul style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;"><li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">выработка списка национальных интересов;</li>
<li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">стратегические исследовательские программы, публичные и закрытые исследования в интересах бизнеса и государства;</li>
<li style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0 0 0 5px; padding: 0; list-style: inside;">экспертная и нормотворческая деятельность.</li>
</ul><p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
Клуб Директоров – это закрытая площадка, на которой члены КД (руководители компаний из отраслей: медиа, интернет, производители ПО, телеком) организуют периодические встречи, дискуссии на актуальные темы, формируют повестку развития отрасли, встречаются с представителями власти, получают новые экспертные оценки от ведущих российских и зарубежных специалистов. Членами клуба могут являться как собственники или руководители бизнесов, так и ключевые персоны, оказывающие непосредственное влияние на деятельность компании и отрасли.</p>
