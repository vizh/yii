...
<p>Вы&nbsp;выбрали основным или дополнительным направлением своей работы «Интернет+МЕДИА» на&nbsp;2016&nbsp;г.</p>
<p>ИРИ в&nbsp;рамках инициативы центра компетенции «Интернет+Медиа» проводит опрос экспертов ИРИ по&nbsp;определению единых стандартов лояльной пользователю сети Интернет форматов рекламы. Выработанная единая позиция отрасли направлена на&nbsp;консолидацию действий для решения проблем распространения блокировщиков рекламы.</p>
<p>Опрос проводится в&nbsp;течение 1&nbsp;недели до&nbsp;12&nbsp;июля 2016&nbsp;г. включительно.</p>

<p style="margin-top: 10px 0; text-align: center;">
	<b>Нам важно Ваше экспертное мнение!</b><br/><a href="http://experts.iri.center/vote/advertising?runetid=<?=$user->RunetId;?>&hash=<?=substr(md5('10tit9Waey8ffMo1quae7Halichu4e2OoZoo0Ah14d4'.$user->RunetId), 0, 40);
