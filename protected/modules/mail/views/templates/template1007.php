...
<head>
    ...
    <title>Образование сегодня не может существовать без Интернета. Всего за несколько лет обучение через сеть превратилось из развлечения в серьезную альтернативу офлайн-образованию, изменив понятия “ученика” и “учителя” и пространство, где они встречаются.</title>
    <style>.btn-primary {
...
<p>Образование сегодня не&nbsp;может существовать без Интернета. Всего за&nbsp;несколько лет обучение через сеть превратилось из&nbsp;развлечения в&nbsp;серьезную альтернативу офлайн-образованию, изменив понятия «ученика» и&nbsp;«учителя» и&nbsp;пространство, где они встречаются.</p>
<p>Каким онлайн-образование будет завтра&nbsp;— зависит от&nbsp;нас и&nbsp;тех критериев качества образовательных курсов, которые разработает интернет-индустрия совместно с&nbsp;ВУЗами и&nbsp;представителями бизнеса.</p>

<p style="margin-top: 10px 0; text-align: center;"><a href="http://experts.iri.center/vote/education?runetid=<?=$user->RunetId;?>&hash=<?=substr(md5('10tit9Waey8ffMo1quae7Halichu4e2OoZoo0Ah14d4'.$user->RunetId), 0, 40);
...
<p>Опрос завершится 30 мая в 15:00. Результаты опроса будут объявлены на&nbsp;открытии форума «Интернет+Образование» 31&nbsp;мая 2016&nbsp;г. В&nbsp;Международном пресс-центре МИА «Россия сегодня». Участие в&nbsp;форуме бесплатное, <a href="https://runet-id.com/event/iri-forum-edu16">регистрация онлайн обязательна</a>.</p>
<p>Для представителей из&nbsp;регионов организована возможность виртуального участия в&nbsp;Форуме и&nbsp;просмотр <a href="http://experts.iri.center/education/video">прямой трансляции</a> из&nbsp;всех залов на&nbsp;крауд-платформе ИРИ. Просмотр будет доступен в&nbsp;день форума после предварительной регистрации.</p>
<p><a href="http://forums.iri.center/education/program">Программа форума »</a></p>
