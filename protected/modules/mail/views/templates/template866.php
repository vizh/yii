...
<head>
    ...
    <title>Институту Развития Интернета поручено создать Рабочую группу “Экспертиза законопроекта ‘НДС для IT-компаний’” на базе ИРИ</title>
    <style>.btn-primary {
...
<ol>
	<li>Верификация образовательных онлайн курсов</li>
	<li>Открытие доступа к&nbsp;дипломным работам</li>
	<li>Общественное достояние государства</li>
	<li>Развитие информационного общества</li>
	<li>Развитие практикоориентированного обучения и&nbsp;изучения отечественных разработок в&nbsp;ВУЗах</li>
	<li>Увеличение востребованности ИТ-специальностей абитуриентами</li>
	<li>Развитие дополнительного образования</li>
</ol>

<p style="margin-top: 10px 0; text-align: center;"><a href="http://iri.center/edu-vote/" style="font-size: 100%; color: #FFF; text-decoration: none; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: uppercase; background-color: #B33689; margin: 0 10px 0 0; padding: 0; border-color: #B33689; border-style: solid; border-width: 10px 40px;">Перейти к опросу</a></p>

<p>22&nbsp;апреля в&nbsp;Международном мультимедийном пресс-центре МИА «Россия сегодня» пройдет тематический форум «Интернет + Образование». </p>
<p>Адрес для предложений по&nbsp;программе, тем для обсуждения <a href="mailto:education@iri.center">education@iri.center</a></p>

<hr />

<p><b>Дополнительные материалы:</b></p>
<ul>
	<li><a href="/upload/files/20160329/1.Protocol.docx">Протокол рабочей встречи Экспертного Совета ИРИ и приглашенных экспертов по направлению «Интернет + Образование»</a> (94Кб, Word)</li>
	<li><a href="/upload/files/20160329/2.Roadmap.pdf">«Дорожная карта» — Образование</a> (93Кб, Word)</li>
	<li><a href="/upload/files/20160329/3.List-orders.doc">Перечень поручений по итогам первого российского форума «Интернет экономика»</a> (101Кб, PDF)</li>
</ul>
