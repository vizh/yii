...
<p>Институт Развития Интернета проводит опрос, цель которого дать оценку соответствия электронных государственных услуг и&nbsp;сайтов государственных структур потребностям и&nbsp;запросам общества.</p>
<p>Нам очень важно Ваше мнение по&nbsp;данному вопросу. Просим Вас подключиться к&nbsp;участию и&nbsp;ответить на&nbsp;вопросы до&nbsp;18.00 10&nbsp;июня 2016&nbsp;года.</p>
<p style="margin-top: 10px 0; text-align: center;"><a href="http://experts.iri.center/vote/society?runetid=<?=$user->RunetId;?>&hash=<?=substr(md5('10tit9Waey8ffMo1quae7Halichu4e2OoZoo0Ah14d4'.$user->RunetId), 0, 40);
...
<p>Результаты исследования ИРИ представит 14&nbsp;июня 2016 года на&nbsp;Форуме «Интернет+Общество», который пройдет в&nbsp;МИА «Россия сегодня» по&nbsp;адресу&nbsp;г. Москва, Зубовский бульвар, д.4.</p>
<ul> 
	<li><a href="http://forums.iri.center/society/program">Программа форума »</a></li>
	<li><a href="https://runet-id.com/event/iri-forum-soc16">Быстрая регистрация »</a></li>
 </ul>

<p>C уважением,<br />
Институт Развития Интернета<br />
</td>
                </tr>
                </table>
            </div>
