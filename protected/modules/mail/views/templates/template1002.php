                        ...
                        <table cellpadding="10" cellspacing="10" border="0" width="100%">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p>Большое спасибо, что стали участником конференции
                                        <a href="http://www.msdevcon.ru/">DevCon
                                                                          201</a>6!
                                       Нам очень важно узнать ваше мнение о мероприятии.
                                    </p>

                                    <p>По этим индивидуальным ссылкам вы можете оценить доклады и заполнить анкету
                                       участника
                                       мероприятия. Обратите внимание, что <strong>заполнение анкеты участника доступно
                                                                                   с 10:00
                                                                                   до 23:59 26 мая, а оценка докладов с
                                                                                   10:00 25
                                                                                   мая до 23:59 26 мая.</strong> Мы
                                       предусмотрели для вас приятные сюрпризы, которые гарантированно получит каждый
                                       заполнивший анкету!
                                    </p>
                                    ...
                                    <div style="text-align: center; background: #ffffff; border: 2px dashed #FFFFFF; padding: 10px;">
                                        ...
                                        <p style="margin-top: 0">
                                            ...
                                            <a href="https://events.techdays.ru/Voting/Fill/<?=$apiExtUser
                                                ? $apiExtUser->ExternalId
                                                : ''?>" style="font-size: 100%; color: #FFF; text-decoration: none; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: uppercase; background-color: #348eda; margin: 0 10px 0 0; padding: 0; border-color: #348eda; border-style: solid; border-width: 10px 40px;">Оценить
                                                                                                                                                                                                                                                                                                                                                                                     доклады</a>
                                        </p>
                                    </div>

                                    <p>Делитесь своими впечатлениями о конференции с хэштегом
                                        <a href="https://twitter.com/hashtag/msdevcon?f=realtime&amp;src=hash">#msdevcon</a>
                                    </p>
                                    ...
                                    <p>С уважением,<br/>
                                       Команда организаторов конференции DevCon 2016
                                    </p>
