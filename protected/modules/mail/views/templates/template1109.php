			...
			<table border="0" cellpadding="0" cellspacing="0" class="templateContainer" width="100%">
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="max-width:100%; min-width:100%;" width="100%">
										<tbody>
											<tr>
												...
												<div style="text-align: center;"><span style="color:#4B0082"><strong><span style="font-size:32px">Уважаемые участники конференции&nbsp;#EdCrunch!</span></strong></span></div>
												</td>
											</tr>
										</tbody>
									</table>
				...
				<![endif]-->
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="max-width:100%; min-width:100%;" width="100%">
										<tbody>
											<tr>
												<td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">Программный комитет конференции под эгидой &laquo;РЫБАКОВ ФОНД&raquo; организует в рамках конференции&nbsp;#EdCrunch&nbsp;2016 МОЗГОВОЙ ШТУРМ &quot;Какой быть Корпоративной Сетевой Академии?&quot;<br />
												<br />
												Приглашаем к участию!<br />
												<br />
												Количество мест ограничено.<br />
												<br />
												Руководитель сессии - Дмитрий Волошин, Директор корпоративной сетевой академии &laquo;Ростех&raquo;<br />
												<br />
												<strong>Для участия в сессии просим Вас ответить на вопросы анкеты:</strong><br />
												<br />
												1. Фамилия и имя<br />
												2. Текущее место работы<br />
												3. Что Вы знаете о ГК &laquo;Ростех&raquo;?<br />
												4. Какая цель Вашего участия в воркшопе?<br />
												5. Какие Ваши ожидания от участия в воркшопе?<br />
												6. Ваши контактные данные&nbsp;email,&nbsp;tel<br />
												Анкета находится по ссылке:</td>
											</tr>
										</tbody>
									</table>
									<!--[if mso]>
							...
							<tbody class="mcnButtonBlockOuter">
								<tr>
									...
									<table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-top-left-radius: 3px;border-top-right-radius: 3px;border-bottom-right-radius: 3px;border-bottom-left-radius: 3px;background-color: #2BAADF;">
										<tbody>
											<tr>
												<td align="center" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;" valign="middle"><a class="mcnButton " href="https://drive.google.com/open?id=1SxQU46FEOJYuK_lXDTAnja-nmJbK7A-YZXrvK3PKizI" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;" target="_blank" title="Заполнить анкету">Заполнить анкету</a></td>
											</tr>
										</tbody>
									</table>
									</td>
				...
				<![endif]-->
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="max-width:100%; min-width:100%;" width="100%">
										<tbody>
											<tr>
												<td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">О включении вас в число участников сессии мы сообщим вам по почте.<br />
												<br />
												<em>Оргкомитет конференции&nbsp;EdCrunch 2016</em></td>
											</tr>
										</tbody>
									</table>
									<!--[if mso]>
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="max-width:100%; min-width:100%;" width="100%">
										<tbody>
											<tr>
												...
												<p>Следите за новостями #EdCrunch в социальных сетях!</p>
												</td>
											</tr>
										</tbody>
									</table>
