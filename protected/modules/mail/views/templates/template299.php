...
<table style="width:100%; margin: 0 auto">
	<tbody>
		<tr>
			<td style="width: 15%; vertical-align:middle; text-align: center; border-right: 1px solid #CCC; padding-right: 20px; font-size: 14px" >
				<img alt="" src="http://runet-id.com/img/mail/2015/pgconf/bartunov.jpg" style="-webkit-border-radius: 100px; -moz-border-radius: 100px; border-radius: 100px; margin: 0 auto" width="150" />
				<b><p>Олег Бартунов</p></b>
			</td>
			<td style="padding-left: 20px; font-size: 14px">
			<i>
				<p>
					«На роль высококвалифицированных разработчиков PostgreSQL не годятся «ребята, которые закончили школу, начинающие программисты. Это должны быть серьезные специалисты с уровнем не ниже, чем тот, который представлен в международном сообществе PostgreSQL. Эти люди должны иметь свободный английский, должны уметь cтавить задачу, контролировать, вести долгие споры, даже интриговать, добиваясь принятия нужного решения - «все это те скиллы, которые сейчас отсутствуют у нас как класс.
				</p>
				<p>
