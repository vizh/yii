...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
  <head>
    ...
    <title>Приглашение на заседание Набсовета 30 сентября</title>
<style>.btn-primary {
...
обсудить документ на мероприятии!
                ...
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Приглашаем Вас принять участие в заседании Наблюдательного совета ИРИ!
                </p>



                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    Сбор гостей в 11.30. Программа мероприятия прилагается.
                </p>

                <p style="text-align:right; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    <i>С уважением, <br />
Председатель Совета ИРИ  Герман Клименко <br />
и члены Совета ИРИ </i><br />
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    <i>Просим Вас подтвердить участие в мероприятии!
Дополнительную информацию можно получить у директора по коммуникациям ИРИ Андрея Воробьева по электронной почте pr@iri.center или по телефону +7 916 570-40-29.</i>
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    <b>Программа мероприятия</b>

                    11.30 - 12.00 Регистрация участников, кофе;<br/>

                    12.00 - 12.30 Выступление членов Совета ИРИ;<br/>

                    12.30 - 13.00 Выступления членов Совета ИРИ<br/>
...
развития сети Интернет и связанных с ней отраслей экономики;<br/>
                    ...
                    13.00 - 14.00 Экспертные замечания членов Наблюдательного совета;<br/>

                    14.00 – 15.00 Неформальное общение, фуршет;<br/>
                </p>

                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                    <i>Обращаем внимание, что в настоящее время гостям отеля «Арарат Парк

                        Хаятт» рекомендуется парковка ЦУМа (напротив здания отеля).

                        В ЦУМе работает крупнейшая в Москве подземная парковочная площадка,

                        которая соответствует самым современным требованиям и оборудована

                        по последнему слову техники.</i>
                </p>
