...
<title>RUVENTS: Быстрая и технологичная регистрация</title>
</head>
<body bgcolor="#F3F1ED" style="-webkit-font-smoothing: antialiased; height: 100%; -webkit-text-size-adjust: none; width: 100% !important; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.5em; margin: 0; padding: 0;">
<style type="text/css">
...
<!-- /unboxed --><!-- body --><table class="body-wrap" bgcolor="#F3F1ED" style="border-collapse: collapse; width: 100%; margin: 0; padding: 20px;"><tr style="margin: 0; padding: 0;">
<td style="vertical-align: top; margin: 0; padding: 0;" valign="top"></td>
		    <td class="container" bgcolor="#F3F1ED" style="vertical-align: top; clear: both !important; display: block !important; max-width: 600px !important; margin: 0 auto; padding: 20px;" valign="top">

		      <!-- content -->
		      <div class="content" style="display: block; max-width: 600px; margin: 0 auto; padding: 0;">

		      	<div class="center" style="text-align: center; margin: 0 0 75px; padding: 0;" align="center">
		      	...
		      	<p class="center" style="text-align: center; font-size: 14px; font-weight: normal; margin: 0 0 10px; padding: 0;" align="center"><a href="http://events.runet-id.com/2016/" style="color: #D85B42; margin: 0; padding: 0;">Главные IT-мероприятия »</a></p>
