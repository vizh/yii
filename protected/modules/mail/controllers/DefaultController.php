...
*/
    ...
    */
    ...
    $criteria->addInCondition('"Participants"."EventId"', array(827));
...
//        $mail->SetFrom('reg@ibcrussia.com', 'IBC Russia 2013', false);
        $mail->CharSet = 'utf-8';
        $mail->Subject = '=?UTF-8?B?'. base64_encode('III Инновационный форум Промсвязьбанка: Путевой лист') .'?=';
        $mail->Body = $body;
