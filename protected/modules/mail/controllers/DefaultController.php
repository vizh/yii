...
//    $criteria->addInCondition('"Participants"."PartId"', array(19));
    ...
    $criteria->addCondition('"Participants"."UserId" IN (SELECT "UserId" FROM "EventParticipant" WHERE
      ("RoleId" IN (11) AND "EventId" = 425) OR
      ("RoleId" IN (1) AND "EventId" = 422)
    )');
