...
<div class="contacts">
    ...
    <?if ($address !== null):?>
        <p class="address" itemprop="location" itemscope itemtype="http://schema.org/Place"><span itemprop="address"
                                                                                                  itemscope
                                                                                                  itemtype="http://schema.org/PostalAddress"><?=$address->getWithSchema()?></span>
        </p>
    <?endif?>
    <?if (!empty($phones)):?>
        <p class="telephone">
