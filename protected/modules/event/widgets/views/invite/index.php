...
<p>К участию в конференции приглашаются стартап-проекты, представители
    финансовых организаций, венчурных фондов и высокотехнологичных
    компаний. Отбор участников проводится организаторами. Для этого при
    регистрации необходимо указать ссылку на свой профайл в одной из
    социальных сетей и ответить на дополнительный вопрос.</p>


<p>Для получения аккредитации на мероприятия пишите на <a href="mailto:svmr@digitaloctober.com">svmr@digitaloctober.com</a></p>