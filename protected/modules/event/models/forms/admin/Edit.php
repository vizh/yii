...
class Edit extends \CFormModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['Free, Top, UnsubscribeNewUser, RegisterHideNotSelectedProduct, NotSendRegisterMail, NotSendChangeRoleMail, CloseRegistrationAfterEnd, DocumentRequired, UseQuickRegistration', 'boolean', 'allowEmpty' => true],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'UseQuickRegistration' => Yii::t('app', 'Использовать быструю регистрацию'),
    ...
    {
        $this->Address->attributes = Yii::app()
            ->getRequest()
            ->getParam(get_class($this->Address));
        ...
        $this->Phone->attributes = Yii::app()
            ->getRequest()
            ->getParam(get_class($this->Phone));
