...
<p style="font-family: Segoe UI, Tahoma,Arial,Helvetica, sans-serif; font-size: 14px;">Код подтверждения (действителен в течении 5 минут):<br/>
<strong><?=$code;?></strong></p>

<p style="font-family: Segoe UI, Tahoma,Arial,Helvetica, sans-serif; font-size: 14px;">Благодарим за понимание!</p>
