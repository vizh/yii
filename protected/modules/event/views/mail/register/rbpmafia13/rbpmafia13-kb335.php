<?=$user->getShortName()?>, добрый день! 0000

Спасибо за регистрацию на  вечеринку: <?=$event->Title?>.

Дата проведения: 19 декабря 2013 года.
Место проведения: SIMON SAYS BAR  ( г. Москва, Кудринская площадь , д. 1)
