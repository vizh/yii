                    ...
                    <td style="padding-top: 20px; padding-left: 30px; padding-right: 30px; background-color: #ffffff">
                        <table style="width: 100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                ?>
                                <td align="right" style="padding-top: 5px;">Код участника: <strong><?=substr($externalUser->ExternalId, 0, 8);?></strong></td>
                            </tr>
                            <tr>
                            ...
                            <?if ($event->getContactAddress() != null):?>
                                ...
                                <tr>
                                    <td style="padding-top: 10px;">
                                        <b><?=$event->getContactAddress()->Place;?></b><br>Волгоградский проспект, д. 42/5
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tr>
                                <td style="text-align: center; padding: 20px 0px 0; font-size: 11px;">
                                    <p>
                                        <?if ($event->getContactSite() != null):?> Подробная информация: <a href="http://www.russianappday.ru" target="_blank">www.russianappday.ru</a> | <?endif;?>Служба поддержки: <a href="mailto:users@runet-id.com">users@runet-id.com</a><br/>
