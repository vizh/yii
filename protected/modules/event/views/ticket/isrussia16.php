...
<section>
    <div class="main">
        ...
        <?php else :?>
            ...
            <p>
                Обращаем Ваше внимание, что 3 ноября 2016 года, в связи с проведением мероприятия с возможным присутствием первых лиц государства на территории ЦВК «Экспоцентр», будет закрыт Западный вход со стороны метро Выставочная.
