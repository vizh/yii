...
<section>
    <div class="main">
        ...
        <?php else :?>
            ...
            <p>
                <b>ВНИМАНИЕ!</b> Обращаем Ваше внимание, что <span style="color: red">3 ноября 2016 года</span>, в связи с проведением мероприятия с возможным присутствием первых лиц государства на территории ЦВК «Экспоцентр», будет закрыт Западный вход со стороны метро Выставочная.
                Просим Вас пользоваться Северным и Южным входами и зонами регистрации. Приносим извинения за доставленные неудобства.
            </p>
