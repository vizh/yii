                                ...
                                <tr>
                                    <td style="padding-top: 10px; text-align: center;">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 45%;"><img style="border: 1px solid;  height: 330px;" src="http://static-maps.yandex.ru/1.x/?l=map&ll=<?=$event->getContactAddress()->getLongitude();?>,<?=$event->getContactAddress()->getLatitude();?>&z=14&size=330,330&pt=<?=$event->getContactAddress()->getLongitude();?>,<?=$event->getContactAddress()->getLatitude();?>,pm2ntl" border="0"/></td>
                                                <td style="text-align: left; padding-left: 20px;">
                                                    <p style="font-size: 15px; padding-bottom: 5px; font-weight: bold;">КАК ДОБРАТЬСЯ:</p>
                                                    <p style="padding-bottom: 5px;">Симферополь – Ялта</p>
                                                    <p style="padding-bottom: 5px;">Симферополь (ж/д вокзал) – Ялта (автовокзал) – 90 км. Рейсовые автобусы, троллейбусы, маршрутные такси.</p>
                                                    <p style="padding-bottom: 5px;">Симферополь (аэропорт) – Ялта (автовокзал) – 100 км. Рейсовые автобусы, маршрутные такси.</p>
                                                    <p style="padding-bottom: 5px;">Ялта (автовокзал ) – гостиница «Ялта-Интурист». Автобус или троллейбус №1 – остановка «Центр», Остановка «Центр» (маршрутное такси № 34) - гостиница «Ялта-Интурист».</p>
                                                    <p>Также Вы можете воспользоваться такси.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
