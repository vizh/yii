                  ...
                  <table>
                    <tr>
                      <td>
                        ...
                        <br><br>
                        <span style="font-size: 20px;"><?$this->widget('event\widgets\Date', ['event' => $event, 'html' => false]);?>, начало в 14:30<div class="event-partners">
                                <h2 class="title"><small>ПАРТНЕРЫ</small></h2><!-- /title -->
                                <div class="bl bl-grey">
                                    <div class="container-fluid">

                                        <div class="row">
                                            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">

                                                <strong class="partners-title">СТРАТЕГИЧЕСКИЕ ПАРТНЕРЫ</strong><!-- /partners-title -->
                                                <ul class="partners-list">
                                                    <li>
                                                        <a href="#" class="partners-image"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="partners-image"></a>
                                                    </li>
                                                ...
                                                <strong class="partners-title">ИНФОРМАЦИОННЫЕ ПАРТНЕРЫ</strong><!-- /partners-title -->
                                                <ul class="partners-list">
                                                    <li>
                                                        <a href="#" class="partners-image"></a>
                                                    </li>
                                                ...
                                                <strong class="partners-title">ГЕНЕРАЛЬНЫЕ ПАРТНЕРЫ</strong><!-- /partners-title -->
                                                <ul class="partners-list">
                                                    <li>
                                                        <a href="#" class="partners-image"></a>
                                                    </li>
                                            ...
                                            </div><!-- /col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 -->
                                        </div><!-- /row -->

                                    </div><!-- /container-fluid -->
                                </div><!-- /bg bl-grey -->
                            </div><!-- /event-partners --></span>
                      </td>
                      <td>
