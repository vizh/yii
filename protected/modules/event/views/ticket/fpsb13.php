    ...
    <tr>
      <td>
        <table style="width: 100%;" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center"><img src="http://runet-id.com/img/event/fpsb13/header-bg.jpg" width="715" /></td>
          </tr>
          <tr>
            <td style="padding-top: 20px; padding-left: 30px; padding-right: 30px; background-color: #ffffff">
              <table style="width: 100%" cellpadding="0" cellspacing="0">
                    ...
                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="45%" style="background-color: #ececec; padding: 5px;">
                          <strong>Время работы стойки регистрации</strong><br/><span>22 ноября с 08:45</span>
                        </td>
                        <td width="45%" style="background-color: #ececec; padding: 5px;">
                          <strong>Начало конференции</strong><br/><span>22 ноября с 09:30</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding-top: 10px;">
                    <p><b>22 ноября 2013 года, Digital October</b></p>
                    <p>г. Москва, Берсеневская наб., д. 6, стр. 3</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding-top: 10px; text-align: center;"><img style="border: 1px solid;" src="http://runet-id.com/images/mail/fpsb13/map.gif" border="0"/></td>
                </tr>

                <tr>
                  <td style="text-align: center; padding: 20px 0px 0; font-size: 11px;">
                    <p>Подробная информация: <a href="http://www.psbforum.ru" target="_blank">www.psbforum.ru</a> | Служба поддержки: <a href="mailto:ideasupport@psbank.ru">ideasupport@psbank.ru</a></p>
                  </td>
                </tr>
                <tr>
