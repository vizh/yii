...
<div class="container event-create">
  <div class="row">
    <div class="span12">
      ...
      <p>С помощью нашего календаря вы можете не только анонсировать событие, но и организовать регистрацию на мероприятие, а также приём оплаты за участие. Сегодня на портале RUNET-ID зарегистрированно почти 200 тысяч профессионалов IT и медиа, которых может заинтересовать ваш проект.</p>
