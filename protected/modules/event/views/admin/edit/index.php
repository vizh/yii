    ...
    <div class="well">
        ...
        <div class="row-fluid">
            <div class="span7">
                ...
                <div class="control-group">
                    ...
                    <?php $this->widget('contact\widgets\AddressControls', ['form' => $form->Address]) ?>
                </div>

                <div class="control-group">
                    <?= CHtml::activeLabel($form, 'Phone', ['class' => 'control-label']); ?>
                    <?php $this->widget('contact\widgets\PhoneControls', ['form' => $form->Phone]) ?>
                </div>
            ...
            <div class="span5">
                ...
                <?php if ($event->External == true): ?>
                    ...
                    <?php if (isset($event->ContactPerson)): ?>
                        <div class="control-group">
        ...
        <div class="row-fluid">
                ...
                <?php foreach ($widgetsAll[WidgetPosition::Sidebar] as $widget): ?>
                    ...
                    <div class="m-bottom_10 row-fluid">
                        ...
                        <div class="span4">
                            ...
                            <?php if ($widget->getAdminPanel() !== NULL && isset($widgets->Used[$class])): ?>
            ...
            <div class="span4">
                ...
                <?php foreach ($widgetsAll[WidgetPosition::Content] as $widget): ?>
                    <? $class = get_class($widget); ?>
                    <div class="m-bottom_10 row-fluid">
                        <div class="span8">
                            <label
