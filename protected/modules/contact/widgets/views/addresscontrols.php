...
<div class="widget-address-controls">
    ...
    <? if ($geoPointCoordinates): ?>
        ...
        <div class="controls m-top_5">
            <?=CHtml::textField('contact\models\forms\Address[GeoPoint][]', $form->GeoPoint[0], [
            ...
            <?=CHtml::textField('contact\models\forms\Address[GeoPoint][]', $form->GeoPoint[1], [
            ...
            <?=CHtml::textField('contact\models\forms\Address[GeoPoint][]', $form->GeoPoint[2], [
