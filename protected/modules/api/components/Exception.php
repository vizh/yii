...
class Exception extends \CException
{
    ...
    private $codes = array(
        ...
        901 => 'Профессиональный интерес ID:%s не найден',

        /* Ошибка работы с ИРИ  */
        1001 => 'Роль с ID:%s не найдена',
        1002 => 'Пользователь с RUNET-ID %s уже имеет роль с ID:%s в ИРИ',
        1003 => 'Пользователь с RUNET-ID %s не является участником ИРИ, имеющий роль с ID:%s',
        1004 => 'Не задан тип пользователя',
