...
```json
{
    "Id": 2817,
    "Place": "LNK[Место](#5-6)",
    "Creator": "LNK[Пользователь](#5-16)",
    "Users": [
        {
            "Status": 1,
            "Response": "",
            "User": "LNK[Пользователь](#5-16)"
        }
    ],
    "UserCount": 1,
...
```json
{
    ...
    "Status": "LNK[Статус пользователя](#5-17)",
...
```json
{
    "Sender": "LNK[Пользователь](#5-16)",
    "Owner": "LNK[Пользователь](#5-16)",
...
## 15.2. Список участников комиссии РАЭК
