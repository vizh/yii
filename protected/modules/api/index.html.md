...
# 13. Материалы Paperless

Методы для работы с механикой Paperless.

## 13.1. Отметка о прикладывания бейджа к устройству
...
## 14.7. Список оплаченных заказов
...
## 16.2. Список участников комиссии РАЭК
