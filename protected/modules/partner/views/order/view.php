...
<div class="panel panel-info">
    ...
    <?if(OrderType::getIsBank($order->Type)):?>
        <div class="panel-footer">
            <div class="btn-group">
                <?if(!$order->Deleted):?>
                    <?if(!$order->Paid && $this->getAccessFilter()->checkAccess('partner', 'order', 'activate')):?>
                    ...
                    <?endif?>
                    <?if($order->getIsBankTransfer() && !$order->Paid && $this->getAccessFilter()->checkAccess('partner', 'order', 'edit')):?>
                        <?=\CHtml::link('<span class="fa fa-pencil"></span> Редактировать', ['edit', 'id' => $order->Id], ['class' => 'btn btn-info'])?>
                    <?endif?>
                    <?if(!$order->Paid  && $this->getAccessFilter()->checkAccess('partner', 'order', 'delete')):?>
