    ...
    public function getQuestions()
    {
        if ($this->questions == null) {
            $this->questions = [
                ...
                'q2_6'  => 'Насколько для вас оказалось полезным посещение выставки Microsoft',
                'q2_7'  => 'Выставка партнеров конференции',
                'q2_8'  => 'Информационный пакет участника (качество рюкзака и материалов внутри)',
