 ...
 */
?>
<h3>Пожалуйста, прочитайте полностью позитивный и негативный прогнозы развития сегмента <strong><?=$question->getSelectSegmentTitle();?></strong> в россии до 2018 г. оцените вероятность реализации каждого прогноза в %.</h3>
