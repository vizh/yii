<?php
/**
 * @var $question \competence\models\tests\mailru2013\A5
 */
$fullData = $question->getFullData();

$base = new \competence\models\tests\mailru2013\A4($question->getTest());
...
<h3>В&nbsp;каких источниках Вы&nbsp;видели/слышали о&nbsp;каждом из&nbsp;этих людей?</h3>
