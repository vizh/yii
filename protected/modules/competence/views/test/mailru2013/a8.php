<?php
/**
 * @var $question \competence\models\tests\mailru2013\A8
 */
...
<h3><strong>Первые лица</strong> каких компаний наиболее интересны для Вас на профессиональных выставках/мероприятиях?</h3>
