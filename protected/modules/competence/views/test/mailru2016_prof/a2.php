<?php
/**
 * @var $form \competence\models\test\mailru2016_prof\A2
 */

$manager = \Yii::app()->getAssetManager();
$path = $manager->publish(\Yii::getPathOfAlias('competence.assets') . '/images/mailru2016_prof');

\Yii::app()->getClientScript()->registerScriptFile($manager->publish(\Yii::getPathOfAlias('competence.assets') . '/js/mailru2016_prof/a2.js'), \CClientScript::POS_END);
?>
