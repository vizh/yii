<?php
/**
 * @var $form \competence\models\test\mailru2016_prof\E3
 */
$manager = \Yii::app()->getAssetManager();
//\Yii::app()->getClientScript()->registerScriptFile($manager->publish(\Yii::getPathOfAlias('competence.assets') . '/js/mailru2016_prof/e3.js'), \CClientScript::POS_END);
?>
<ul class="unstyled">
