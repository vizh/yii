...
<div class="container interview m-top_30 m-bottom_40">
    <div class="row">
        <div class="span8 offset2 m-top_30 text-center">
            ...
            <?php if (!empty($test->Info)):?>
                <?=$test->Info;?>
            <?php else:?>
                <p class="lead">Спасибо за готовность оставить свое мнение о мероприятии, заполнив анкету участника <?=$event->Title;?>. Это займет у вас не более <nobr>5-ти</nobr> минут.</p>
            <?php endif;?>
