...
<DIV id=content>
  <TABLE cellSpacing="0" cellPadding="5" width="720" border="0">
    <TBODY>
    <TR>
        <TD><b>ООО «Онтико»</b><BR>Адрес: Российская Федерация, 119180, г.Москва, Бродников пер., д.7, стр.1<BR>тел. +7 (495) 646-07-68 доб. 3001</TD>
      <td align="right"><img src="/img/pay/bill/ontico/logo.png" width="150" height="61"></td>
    ...
    <TR>
      <TD colspan="2">
        ...
        <TABLE style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; WIDTH: 100%; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid" cellSpacing="0" cellPadding="3">
          <TBODY>
          <TR>
            <TD style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid">ИНН 7706681097</TD>
          ...
          <TR>
            <TD style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid"	colSpan=2>Получатель<BR>ООО «Онтико»</TD>
            <TD	style="BORDER-BOTTOM: 1px solid; BORDER-RIGHT: 1px solid"><BR>Сч.&nbsp;№</TD>

            <TD style="BORDER-BOTTOM: 1px solid"><BR>40702810500000032617</TD></TR>
          <TR>
            <TD style="BORDER-RIGHT: 1px solid" colSpan=2>Банк получателя<BR>ВТБ 24 (ЗАО), г. МОСКВА,</TD>
            <TD style="BORDER-RIGHT: 1px solid">БИК<BR>Сч.&nbsp;№</TD>
            <TD>044525716,<BR>30101810100000000716</TD>
      ...
      <TR>
        <TD colspan="2">
          <IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none; width: 600px;"
               src="/img/pay/bill/ontico/sign.jpg"
              />
        </TD>
      </TR>
    <?else:?>
      <tr>
        <td colspan="2" style="border-top: 4px solid #000000;">
          <IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none; width: 600px;"
               src="/img/pay/bill/ontico/nosign.jpg"
              />
        </td>
      </tr>
    <?endif?>
