    ...
    public function processForm()
    {
        ...
        if (empty($scenario)) {
            $this->template->SignFirstImageMargin = [
                $this->form->SignFirstImageMarginTop,
                $this->form->SignFirstImageMarginLeft
            ];
            $this->template->SignSecondImageMargin = [
                $this->form->SignSecondImageMarginTop,
                $this->form->SignSecondImageMarginLeft
            ];
            $this->template->StampImageMargin = [
                $this->form->StampMarginTop,
                $this->form->StampMarginLeft
            ];
        }
        $this->template->save();
