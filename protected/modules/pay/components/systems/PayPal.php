...
class PayPal extends Base
{
    ...
    public function fillParams()
    {
        ...
        if ($ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING") {
            ...
            $url = \Yii::app()->createAbsoluteUrl('/pay/cabinet/index', ['eventIdName' => $order->Event->IdName]);
    ...
    public function processPayment($eventId, $orderId, $total)
    {
        ...
        $params = [
            ...
            'CANCELURL' => \Yii::app()->createAbsoluteUrl('/pay/cabinet/index', ['eventIdName' => $event->IdName]),
            'PAYMENTREQUEST_0_CURRENCYCODE' => 'RUB',
            'NOSHIPPING' => 1
        ];
