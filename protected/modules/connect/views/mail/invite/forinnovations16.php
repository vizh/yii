...
<p>
    ...
    приглашает Вас на деловую встречу в рамках форума «Открытые инновации 2016»
    в <?= $meeting->Date; ?>,
    предлагаемое место встречи: <?= $meeting->Place->Name?>.
</p>
...
<p>
    Принять или отклонить встречу Вы можете в своем
