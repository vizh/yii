...
<div class="row-fluid">
    <div class="span12">
                    ...
                    <tr data-price="<?=$price->Price?>">
                        ...
                        <?else:?>
                            <td style="padding-top: 20px; padding-bottom: 20px;" class="<?=$mutedClass?>">
                                <h4 style="padding: 0; margin: 0;"><?=$product->Title?></h4>
                            </td>
                        <?endif?>
        ...
        <div class="clearfix">
            <img src="/img/pay/pay-methods.png" class="pull-left"
                 alt="<?=\Yii::t('app', 'Поддерживаемые способы оплаты')?>"/>
            <a style="margin-top: -2px; display: inline-block;" href="http://money.yandex.ru" target="_blank"><img
                    src="http://money.yandex.ru/img/yamoney_logo88x31.gif " alt="Я принимаю Яндекс.Деньги"
                    title="Я принимаю Яндекс.Деньги" border="0"/></a>
