<form id="search" action="<?=\Yii::app()->getController()->createUrl('/search/result/index');?>" role="search">
  <div class="container">
    <input type="text" name="term" id="live-search" class="form-element_text ui-autocomplete-input" value="<?=$value?>" placeholder="<?=\Yii::t('app', 'Поиск по людям, компаниям, мероприятиям');?>">
