...
<div class="sidebar-nav">
	...
	<ul class="nav nav-list collapse" id="menu-events">
		...
		<li><a href="<?=Yii::app()->createUrl('/event/admin/list/index', ['Approved' => \event\models\Approved::YES])?>"><?=\Yii::t('app', 'Принятые')?></a></li>
		<li><a href="<?=Yii::app()->createUrl('/event/admin/list/index', ['Approved' => \event\models\Approved::NONE])?>"><?=\Yii::t('app', 'На одобрение')?> <? if ($counts->Event != 0): ?><span class="label label-info pull-right">+<?=$counts->Event?></span><? endif ?></a></li>
		<li><a href="<?=Yii::app()->createUrl('/event/admin/list/index', ['Approved' => \event\models\Approved::NO])?>"><?=\Yii::t('app', 'Отклоненные')?></a></li>
		<li><a href="<?=Yii::app()->createUrl('/event/admin/list/index', ['Deleted' => true])?>"><?=\Yii::t('app', 'Удаленные')?></a></li>
