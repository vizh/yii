var Blog = {
	...
	editPost: function (postId) {
		...
		wu.Ajax('/system/modules/blog/remoteEditPost.php?id=' + postId, 'postText', true, complete);
	},
	
	deletePost: function (postId) {
		if (confirm('Вы уверены, что хотите удалить запись?')) {
			window.location = '/blog/manage/?type=deletePost&id=' + postId;
		}
	},
	...
	getComments: function () {
		...
		wu.Ajax('/system/modules/blog/remoteGetComments.php?id=' + postId, 'comments', true, '');
	},
	...
	editComment: function (commentId) {
		wu.Ajax('/system/modules/blog/remoteEditComment.php?id=' + commentId, 'commentText' + commentId, true, '');
	},
	
	deleteComment: function (commentId) {
		if (confirm('Вы уверены, что хотите удалить комментарий?')) {
			wu.Ajax('/blog/manage/?type=deleteComment&id=' + commentId, 'comment' + commentId, true, '');
		}
	}
