<div class="event-comment-item lvl-0" <?=$this->First? 'style="border:none;"' : '';?>><a name="<?=$this->CommentId;?>"></a>
  <div class="av">
    <img src="<?=$this->UserPhoto;?>" width="50" height="50" alt="<?=$this->FirstName;?> <?=$this->LastName;?>" title="<?=$this->FirstName;?> <?=$this->LastName;?>" />
  </div>
  <div class="sbj">
    <div class="date"><?=$this->Date['mday'];?> <?=$this->words['calendar']['months'][2][$this->Date['mon']]?> <?=$this->Date['year']?></div>
    <div class="nm">
      <a href="/<?=$this->RocId;?>/"><?=$this->FirstName;?> <?=$this->LastName;?></a>
    </div>
    <?=$this->CommentContent;?>
    <div class="clear"></div>
    <?if($this->IsAdmin):?>
    <a href="/news/comment/delete/<?=$this->CommentId;?>/" style="padding-top:5px; color: #910917; display: block;"
