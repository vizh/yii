<tr>
  ...
  <td class="controls">
    <a class="button" href="<?=RouteRegistry::GetAdminUrl('job', '', 'edit', array('id' => $this->VacancyId));?>">
      <span class="pen icon"></span>
    </a>
    <?if ($this->Status != VacancyStream::StatusDeleted):?>
    &nbsp;&nbsp;
    <a class="button negative" href="<?=RouteRegistry::GetAdminUrl('job', '', 'delete', array('id' => $this->VacancyId));?>" onclick="javascript:return confirm('Вы уверены, что хотите удалить вакансию?');">
