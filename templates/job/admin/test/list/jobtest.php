<tr>
  ...
  <td class="controls">
    <a class="button" href="<?=RouteRegistry::GetAdminUrl('job', 'test', 'edit', array('id' => $this->TestId));?>">
      <span class="pen icon"></span>
    </a>
    <?if ($this->Status != VacancyStream::StatusDeleted):?>
    &nbsp;&nbsp;
    <a class="button negative" href="<?=RouteRegistry::GetAdminUrl('job', 'test', 'delete', array('id' => $this->TestId));?>" onclick="javascript:return confirm('Вы уверены, что хотите удалить тест?');">
